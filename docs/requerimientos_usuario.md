...
El backend principal esta en `backend-fastapi` y expone la API REST con FastAPI en `http://localhost:8000/api`. La implementacion esta separada por responsabilidades en `routers`, `services`, `core` y `schemas`.
